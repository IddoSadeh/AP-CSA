...
3. Create a dice roll guessing game. Generate a random number between 1 and 6. Ask the user to guess the result of the dice roll. If the user is correct, let them know. If the user made the wrong guess, allow them another guess.
